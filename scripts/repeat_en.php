 ...
 */
// TODO - locking so cant run 2 instances at once
...
$config->setDebug(true)
        ...
        ->setApiKey(getenv('VIATOR_API_KEY'))
        ->setHostPrefix(getenv('VIATOR_API_HOST_PREFIX'))
        ->setElasticSearchUrl(getenv('VIATOR_ES_URL'))
        ->setlocales(explode(',', getenv('VIATOR_LOCALES')));
...
//$esStorage->setByReference('viator_sync_metadata', 'next_cursor_products_en', array('cursor' => 'MTY0Mzg0NDY5OHwxMDAzMzdQMTc='));

// $esStorage->setByReference('viator_sync_metadata', 'last_update_time_referenced_objects_en', array('value' => '12'));
// $esStorage->setByReference('viator_sync_metadata', 'last_update_time_referenced_objects_fr', array('value' => '12'));
